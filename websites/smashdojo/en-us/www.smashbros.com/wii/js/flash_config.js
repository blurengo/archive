...
function setFlash(verNumber,swfImgName,swfImgWidth,swfImgHeight,swfBgColor,pluginImgName,pluginImgAlt,pluginImgWidth,pluginImgHeight,mapMode,mapName){
	...
	if (getFlashPlayerVersion() < verNumber && mapMode == 1) {
		...
		'<A HREF="http://www.adobe.com/go/getflashplayer_jp" TARGET="_blank"><IMG SRC="' + pluginImgName + '" ALT="' + pluginImgAlt + '" WIDTH="' + pluginImgWidth + '" HEIGHT="' + pluginImgHeight + '" BORDER="0" usemap="' + mapName + '"></A>'
		...
		'<A HREF="http://www.adobe.com/go/getflashplayer_jp" TARGET="_blank"><IMG SRC="' + pluginImgName + '" ALT="' + pluginImgAlt + '" WIDTH="' + pluginImgWidth + '" HEIGHT="' + pluginImgHeight + '" BORDER="0"></A>'
